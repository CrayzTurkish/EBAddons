...
public static void Harass()
        ...
        public static void WaveClear()
        {
            ...
            if (Yasuo.LaneClear["WC.Q"].Cast<CheckBox>().CurrentValue && Player.Instance.IsDashing())
            {
                var pos = DashingManager.GetPlayerPosition(300);
            ...
            if (Yasuo.LaneClear["WC.E"].Cast<CheckBox>().CurrentValue && SpellManager.E.IsReady() && (!minion.GetDashPos().IsUnderTower() || Yasuo.LaneClear["WC.EUnderTower"].Cast<CheckBox>().CurrentValue))
            {
            ...
            if (Yasuo.LaneClear["WC.Q"].Cast<CheckBox>().CurrentValue && SpellManager.Q.IsReady() && DamageHandler.QDamage(minion) > minion.Health)
            {
                SpellManager.Q.Cast(minion);
                return;
            }
            if (Yasuo.LaneClear["WC.Q"].Cast<CheckBox>().CurrentValue && Yasuo.LaneClear["WC.E"].Cast<CheckBox>().CurrentValue && SpellManager.E.IsReady() && SpellManager.Q.IsReady() && DamageHandler.EDamage(minion) + DamageHandler.QDamage(minion) > minion.Health && !minion.GetDashPos().IsUnderTower())
            {
                SpellManager.Q.Cast(minion);
                return;
            }
        ...
        public static void LastHit()
        {
            ...
            if (minion == null) return;
            if (Yasuo.LaneClear["LH.E"].Cast<CheckBox>().CurrentValue && SpellManager.E.IsReady() && DamageHandler.EDamage(minion) > minion.Health && (!minion.GetDashPos().IsUnderTower() || Yasuo.LaneClear["LH.EUnderTower"].Cast<CheckBox>().CurrentValue))
            {
                SpellManager.E.Cast(minion);
                return;
            }
            if (Yasuo.LaneClear["LH.Q"].Cast<CheckBox>().CurrentValue && SpellManager.Q.IsReady() && DamageHandler.QDamage(minion) > minion.Health)
            {
                SpellManager.Q.Cast(minion);
            }
        }
        ...
        public static void Jungle()
        {
            ...
            if (minion == null) return;
            if (Yasuo.LaneClear["JNG.E"].Cast<CheckBox>().CurrentValue && SpellManager.E.IsReady() && DamageHandler.EDamage(minion) > minion.Health && !minion.GetDashPos().IsUnderTower())
            {
                SpellManager.E.Cast(minion);
                return;
            }
            if (Yasuo.LaneClear["JNG.Q"].Cast<CheckBox>().CurrentValue && SpellManager.Q.IsReady())
            {
                SpellManager.Q.Cast(minion);
            }
        }
